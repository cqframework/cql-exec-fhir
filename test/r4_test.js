...
describe('#R4', () => {
  ...
  beforeEach(() => {
    patientSource.loadBundles([
      require('./fixtures/r4/Luna60_McCullough561_6662f0ca-b617-4e02-8f55-7275e9f49aa0.json'),
      require('./fixtures/r4/Johnnie679_Hermiston71_2cd30bd6-3a87-4191-af90-6daa70f58f55.json')
    ]);
  });
